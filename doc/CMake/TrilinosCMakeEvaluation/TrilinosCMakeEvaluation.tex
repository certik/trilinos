...
# Above, add_test(...) would define the tests ArrayRCP_test-one,
# ArrayRCP_test-two-verbose, and ArrayRCP_test-four.
...
system to allow exisitng PACKAGE/test/definition files to be used
without modification.  This will allow us to drop the autotools build
system but still maintain the current perl-based test harness until
such time that the CTest/CDash version can be developed as a good
replacment.
