...
{}\item\textit{Strongly desired}: CMake: Generate error messages that
have line numbers in the corresponding CMakeLists.txt file.
Currently, it just lists the file name.
